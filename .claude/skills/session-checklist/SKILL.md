...
description: Verify non-trivial changes in Serialization before handoff or commit, including supported build systems, tests, configured lint, and diff review.
---
